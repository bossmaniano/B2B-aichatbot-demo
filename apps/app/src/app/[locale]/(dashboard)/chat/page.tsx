...
} from "@osma/elements/conversation";
import {
  Message,
  MessageBranch,
...
} from "@osma/elements/model-selector";
import {
  PromptInput,
  PromptInputButton,
  PromptInputFooter,
  ...
  PromptInputTextarea,
  PromptInputTools,
} from "@osma/elements/prompt-input";
import {
  Reasoning,
  ReasoningContent,
  ReasoningTrigger,
} from "@osma/elements/reasoning";
import {
  Source,
  Sources,
  SourcesContent,
  SourcesTrigger,
} from "@osma/elements/sources";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
  DropdownMenuTrigger,
} from "@osma/ui/dropdown-menu";
  ...
  React.useEffect(() => {
    ...
    const processMessages = async () => {
      for (let i = 0; i < mockMessages.length; i++) {
        ...
        if (msg) await streamMessage(msg);
